...
<table>
    ...
    <tbody>
        <tr>
            ...
            <strong>TB2:</strong> Durante este sprint me mantuve en constante aprendizaje para reforzar mis habilidades en el desarrollo móvil con Kotlin. La implementación del feature Inventory en la kotlin-app requirió investigar nuevas formas de estructurar estados, manejar flujos de datos y optimizar la arquitectura, lo cual me permitió actualizar conocimientos esenciales para mi desarrollo profesional.<br><br>
        ...
        <tr>
            ...
            <strong>TB2:</strong> Al completar esta funcionalidad comprendí que siempre existirán nuevas herramientas, patrones y librerías que debo seguir explorando. Esto reafirma mi necesidad de continuar aprendiendo para responder de manera efectiva a los retos del desarrollo de software.<br><br>
            Guimaraes Escalante, Carlos Eduardo: <br>
            ...
            <strong>TB2:</strong> El trabajo realizado me confirmó que las soluciones de software son dinámicas y requieren una actualización constante. Reconozco que continuar aprendiendo es indispensable para enfrentar nuevos requerimientos y mejorar continuamente mi desempeño.<br><br>
            López De La Cruz, Mauro Fabricio:<br>
            ...
            <strong>TB2:</strong> El proceso me hizo evidente que la tecnología evoluciona rápido y que debo estar en constante aprendizaje para mantenerme competitivo. Reconozco que el desarrollo profesional depende de una mejora continua y del estudio permanente.<br><br>
            Orozco Torres, Álvaro Joaquín:<br>
