    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <p style="margin:2px 0; font-weight:bold;">Contenido</p>
                ...
                <p style="margin:2px 0; text-indent:20px;">1.1.2. Perfiles de los integrantes del equipo</p>
                ...
                <p style="margin:2px 0; text-indent:20px;">2.6.1. Bounded Context: Orders</p>
                ...
                <p style="margin:2px 0; text-indent:20px;">2.6.2. Bounded Context: Shopping</p>
                ...
                <p style="margin:2px 0; text-indent:30px;">2.6.2.5. Bounded Context Software Architecture Component Level Diagrams</p>
                <p style="margin:2px 0; text-indent:30px;">2.6.2.6. Bounded Context Software Architecture Code Level Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.2.6.1. Bounded Context Domain Layer Class Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.2.6.2. Bounded Context Database Design Diagram</p>
                <!-- Bounded Context: Checkout -->
                <p style="margin:2px 0; text-indent:20px;">2.6.3. Bounded Context: Checkout</p>
                ...
                <p style="margin:2px 0; text-indent:30px;">2.6.3.5. Bounded Context Software Architecture Component Level Diagrams</p>
                <p style="margin:2px 0; text-indent:30px;">2.6.3.6. Bounded Context Software Architecture Code Level Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.3.6.1. Bounded Context Domain Layer Class Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.3.6.2. Bounded Context Database Design Diagram</p>
                <!-- Bounded Context: Shop -->
                <p style="margin:2px 0; text-indent:20px;">2.6.4. Bounded Context: Shop</p>
                ...
                <p style="margin:2px 0; text-indent:30px;">2.6.4.5. Bounded Context Software Architecture Component Level Diagrams</p>
                <p style="margin:2px 0; text-indent:30px;">2.6.4.6. Bounded Context Software Architecture Code Level Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.4.6.1. Bounded Context Domain Layer Class Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.4.6.2. Bounded Context Database Design Diagram</p>
                <!-- Bounded Context: Inventory -->
                <p style="margin:2px 0; text-indent:20px;">2.6.5. Bounded Context: Inventory</p>
                ...
                <p style="margin:2px 0; text-indent:30px;">2.6.5.5. Bounded Context Software Architecture Component Level Diagrams</p>
                <p style="margin:2px 0; text-indent:30px;">2.6.5.6. Bounded Context Software Architecture Code Level Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.5.6.1. Bounded Context Domain Layer Class Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.5.6.2. Bounded Context Database Design Diagram</p>
                <!-- Bounded Context: Catalog -->
                <p style="margin:2px 0; text-indent:20px;">2.6.6. Bounded Context: Catalog</p>
                ...
                <p style="margin:2px 0; text-indent:30px;">2.6.6.5. Bounded Context Software Architecture Component Level Diagrams</p>
                <p style="margin:2px 0; text-indent:30px;">2.6.6.6. Bounded Context Software Architecture Code Level Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.6.6.1. Bounded Context Domain Layer Class Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.6.6.2. Bounded Context Database Design Diagram</p>
                <!-- Bounded Context: IAM -->
                <p style="margin:2px 0; text-indent:20px;">2.6.7. Bounded Context: IAM</p>
                ...
                <p style="margin:2px 0; text-indent:30px;">2.6.7.5. Bounded Context Software Architecture Component Level Diagrams</p>
                <p style="margin:2px 0; text-indent:30px;">2.6.7.6. Bounded Context Software Architecture Code Level Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.7.6.1. Bounded Context Domain Layer Class Diagrams</p>
                <p style="margin:2px 0; text-indent:40px;">2.6.7.6.2. Bounded Context Database Design Diagram</p>
...
<img src="./img/insights/tf/commits.png">
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <strong>TB1:</strong> Realice investigaciones relacionadas a segmentos objetivo, diseño de artefactos UX en base a las entrevistas realizadas y traslade las historias de usuario a un software de gestión de proyectos. Estas actividades me han ayudado a mejorar mi capacidad de analisis de segmentos e identificación de necesidades de usuario.<br>
            <strong>TP:</strong> Aprendí acerca del funcionamiento de prototipados y flujos de usuario para contribuir eficientemente en la documentación.<br><br>
            <strong>TB2:</strong> Durante este sprint me mantuve en constante aprendizaje para reforzar mis habilidades en el desarrollo móvil con Kotlin. La implementación del feature Inventory en la kotlin-app requirió investigar nuevas formas de estructurar estados, manejar flujos de datos y optimizar la arquitectura, lo cual me permitió actualizar conocimientos esenciales para mi desarrollo profesional.<br>
            <strong>TF:</strong> Cómo parte del entregable final me centré en el desarrollo y mejora de un segmento de la app. <br><br>
            Guimaraes Escalante, Carlos Eduardo: <br>
            <strong>TB1:</strong>Realice entrevistas relacionadas a los clientes de bodega, participe en la primera sesión del eventstorming para identificar contextos, realice artefactos UX en base a las entrevistas que yo mismo realice y documente diseño táctico de un contexto identificado. Considero que la parte más importante de este primer entregable fue la identificación de contextos, momento en el cual estuve presente y fui un gran aporte.<br>
            <strong>TP:</strong> Mi contribución en este entregable ha sido principalmente en relación al desarrollo de la landing page, para lo cual tuve que refrescar conceptos de programación con frameworks web.<br><br>
            <strong>TB2:</strong> Para desarrollar los features Orders y Finances en la aplicación en kotlin, necesité adquirir nuevos conocimientos relacionados con el manejo de datos, navegación y patrones de arquitectura limpia. Este proceso me permitió fortalecer mis competencias y mantenerme actualizado en tecnologías móviles modernas.<br>
            <strong>TF:</strong> Durante este sprint fortalecí mis conocimientos en Kotlin y en el desarrollo backend con Spring Boot, lo que me permitió intervenir con mayor solidez en las funcionalidades del proyecto. En este periodo refactoricé el módulo de órdenes para que ahora filtre correctamente la información por tienda y colaboré en la mejora de la vista de Finanzas mediante la implementación de una interfaz con dos pestañas más clara y organizada. Asimismo, participé en el desarrollo de las entrevistas de validación dirigidas a los empleados, aportando a la comprensión de sus necesidades y al avance del producto. <br><br>
            López De La Cruz, Mauro Fabricio:<br>
            <strong>TB1:</strong>Participe en el event storming, desarrolle artefactos UX de un segmento objetivo y realice investigaciones mediante fuentes confiables de ese segmento. Al realizar el eventstorming di opiniones que fueron disruptivas para la sesión, siempre cuestionando lo que se daba por sentado. Esto ayudo a que los contextos se definieran correctamente. Eventstorming es una tecnica que recien he aplicado correctamente para este curso.<br>
            <strong>TP:</strong> Para este entregable contribuí en el desarrollo de landing page. Además de actualizar conceptos de desarollo web tuve que mejorar respecto del uso de Git para control de versiones.<br><br>
            <strong>TB2:</strong> Durante este entregable desarrollé los features My Shop, Settings y Auth en la aplicación de Kotlin. Esto implicó investigar técnicas para manejar autenticación, gestión de preferencias y flujos complejos dentro de la aplicación. Cada nuevo reto técnico representó una oportunidad para actualizar mis conocimientos y mejorar mis capacidades.<br>
            <strong>TF:</strong> Durante este sprint actualicé y reforcé mis conocimientos en el desarrollo de soluciones de software utilizando Angular, Supabase y Spring Boot. Estos aprendizajes me permitieron completar de manera óptima las funcionalidades del registro de cuentas para owners y empleados, así como la sección de MyShop, donde implementé el registro de empleados y clientes confiables mediante correo electrónico. Esta actualización de conocimientos fue fundamental para avanzar de forma efectiva en el proyecto. <br><br>
            Orozco Torres, Álvaro Joaquín:<br>
            <strong>TB1:</strong>Participe activamente en el desarrollo del Lean UX, diseño de entrevistas, investigación del domain, Eventstorming, definición del lenguaje ubicuo, definición de historias de usuario y documentación de diseño estratégico y táctico de la solución. Realizar todas estas actividades me ha permitido refrescar mis habilidades comunicativas, analisis de perspectivas del dominio y necesidades del usuario. <br>
            <strong>TP:</strong>Mi contribución se centró principalmente en cuanto a diseño de experiencia de usuario. Diseñando prototipos, tuve que pulir mis habilidades de prototipado para de forma ingeniosa conseguir simular las funcionalidades en Figma. Además, en la implementación front end me encontré con varias dificultades que tuve que sortear leyendo documentación para con entendimiento, dar con soluciones.<br><br>
            <strong>TB2:</strong> A lo largo del sprint trabajé en la refactorización y despliegue de la landing page, además de la documentación del sprint, correcciones del informe y la resolución del spike de Google Maps. Estas tareas exigieron que profundizara en buenas prácticas de frontend, manejo de entornos de despliegue y uso de APIs geoespaciales, lo que actualizó significativamente mis conocimientos.<br>
            <strong>TF:</strong> Para este sprint aprendí a trabajar con cubit para el desarrollo en Flutter. Además aprendí sobre el uso de coordenadas dentro de una aplicación Flutter.<br><br>
            Reaño Delgadillo, Henry Reaño:<br>
            <strong>TB1:</strong>Apoye en el proceso de toma y especificación de requisitos para T'Compro, participe activamente en el el transcurso del Eventstorming y posteriormente contribuí en el diseño estratégico y táctico del proyecto. Todas estas actividades me han permitido rememorar conceptos y skills que tenía poco pulidas. <br>
            <strong>TP:</strong> Para este entregable fui responsable principalmente del backend. Durante el desarrollo, aparte de refrescar conceptos de Java y SpringBoot, tuve que solucionar problemas técnicos de integración con servicios externos como Supabase, que involucraron tanto conocimiento de software puro como de redes.<br><br>
            <strong>TB2:</strong> Durante este entregable corregí errores del backend, desarrollé los features Home y List en Flutter y documenté los servicios correspondientes al sprint. Esto me obligó a actualizar mis conocimientos en Flutter, depuración de APIs y manejo de estados, permitiéndome fortalecer mis capacidades técnicas.<br>
            <strong>TF:</strong> Para el sprint presente mi trabajo fue más de soporte, apoye en la resolución de problemas y solvente dudas con respecto a como funciona el dominio y el backend.<br><br>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
            De Las Casas Latour, Sebastián: <br>
            <strong>TB1:</strong> Como parte de este primer entregable, considero que he realizado un buen trabajo en la identificación de necesidades, dando una buena base al inicio del proyecto. Reconozco que es bueno analizarse a uno mismo e identificar que es lo que se puede mejorar como estudiante.<br>
            <strong>TP:</strong> Reconozco la importancia del aprendizaje en las dificultades que he afrontado para contribuir con mi parte del trabajo de forma efectiva y esperada.<br><br>
            <strong>TB2:</strong> Al completar esta funcionalidad comprendí que siempre existirán nuevas herramientas, patrones y librerías que debo seguir explorando. Esto reafirma mi necesidad de continuar aprendiendo para responder de manera efectiva a los retos del desarrollo de software.<br>
            <strong>TF:</strong> En este último entregable he sentido la utilidad de lo aprendido en el curso, más que nada centrado en la mejora continua de la aplicación desarrollada hasta el momento<br><br>
            Guimaraes Escalante, Carlos Eduardo: <br>
            <strong>TB1:</strong>Siento que este primer entregable fue muy satisfactorio para mi carrera universitaria, pues aplique muchos conceptos que aprendí en ciclos anterior, pero que no había puesto en practica al 100%. En ese aspecto me siento muy satisfecho, he mejorado como estudiante.<br>
            <strong>TP:</strong> Pienso que lo más importante ha sido refrescar conceptos de programación web que tenía desactualizados desde hace mucho tiempo que no practico. Por tanto, entiendo que es importante repasar conceptos y practicar para no perder hábito de desarrollo.<br><br>
            <strong>TB2:</strong> El trabajo realizado me confirmó que las soluciones de software son dinámicas y requieren una actualización constante. Reconozco que continuar aprendiendo es indispensable para enfrentar nuevos requerimientos y mejorar continuamente mi desempeño.<br>
            <strong>TF:</strong> A lo largo del sprint reconocí la importancia de mantener una práctica constante de mejora del código. Investigué nuevas técnicas, patrones y configuraciones que me ayudaron a aplicar buenas prácticas y a optimizar la comunicación entre componentes del sistema. Este proceso reafirmó el valor de la mejora continua, permitiéndome afrontar los desafíos con mayor criterio técnico, elevar la calidad de mis aportes y contribuir de forma más efectiva al cumplimiento de los objetivos del equipo. <br><br>
            López De La Cruz, Mauro Fabricio:<br>
            <strong>TB1:</strong>Reconozco que aplicar tecnicas o metodologias vistas anteriormente en mi carrera en cursos más avanzados me permite mejorar como estudiante.<br>
            <strong>TP:</strong>Reconozco que he dejado de lado algunas buenas prácticas de desarrollo, como el enfoque mobile first o trabajar siempre en base a todos los features esperados para evitar refactorizaciones largas.<br><br>
            <strong>TB2:</strong> El proceso me hizo evidente que la tecnología evoluciona rápido y que debo estar en constante aprendizaje para mantenerme competitivo. Reconozco que el desarrollo profesional depende de una mejora continua y del estudio permanente.<br>
            <strong>TF:</strong> Durante el desarrollo del sprint reconocí la importancia del aprendizaje continuo, ya que para resolver nuevos desafíos investigué prácticas, configuraciones y soluciones necesarias para integrar correctamente autenticación, manejo de datos y comunicación entre servicios. Este proceso evidenció que el aprendizaje permanente es esencial para mejorar mi desempeño profesional y para cumplir con los objetivos del proyecto.<br><br>
            Orozco Torres, Álvaro Joaquín:<br>
            <strong>TB1:</strong> Parte de desarrollar software con metodologias agiles es el proceso iterativo de aprendizaje y reestructuración de features y componentes del sistema. El desarrollo de las actividades de este entregable me ha permitido reconocer la importancia de ser constante en en lo que uno aprende.<br>
            <strong>TP:</strong> Reconozco la importancia del aprendizaje en todos los desafíos que he afrontado en el proceso de diseño e implementación de la User Experience de la aplicación mobile, sobre todo, cuando hay factores que no son directamente medibles como la comodidad, la intuitividad, entre otros.<br><br>
            <strong>TB2:</strong> Al enfrentar estos desafíos comprendí la necesidad de seguir perfeccionando mis habilidades en herramientas web, integración de servicios y documentación técnica. El aprendizaje continuo es clave para poder responder a las necesidades cambiantes del proyecto y del sector tecnológico.<br>
            <strong>TF:</strong> Reconozco que es importante saber adaptarse, para este sprint me encontre con endpoints complicados de entender y de manejar, a pesar de ello, solucione mediante buena prácticas en mi código.<br><br>
            Reaño Delgadillo, Henry Reaño:<br>
            <strong>TB1:</strong> Al contribuir constantemente en el diseño estratégico y táctico de la solución me di cuenta que realmente no hay una arquitectura perfecta, constantemente en equipo ibamos cambiando de ideas y modelos. De esta manera, he podido identificar la necesidad de cuestionar de manera frecuente lo que uno realiza y da por sentado.<br>
            <strong>TP:</strong> Reconozco la relevancia de adquirir conocimiento constantemente, especialmente, en adelante a la toma de algunas decisiones, aunque sea a nivel superficial. En la integración con Supabase hubo problemas de protocolos de comunicación que no me había esperado, y que hubieran hecho que tomara muchas otras consideraciones previas a decidir utilizar dicho servicio.<br>
            <strong>TB2:</strong> Al enfrentar estos desafíos comprendí la necesidad de seguir perfeccionando mis habilidades en herramientas web, integración de servicios y documentación técnica. El aprendizaje continuo es clave para poder responder a las necesidades cambiantes del proyecto y del sector tecnológico.<br>
            <strong>TF:</strong> Reconozco que es importante mantenerse siempre dispuesto a aprender, para este sprint he tenido que corregir y, en ocasiones, enseñar como funciona mi backend para que pueda ser usado correctamente a través de las llamadas en las aplicaciones moviles. <br><br>
            </td>
            <td>
            <strong>TB1:</strong> Todos los miembros del equipo de trabajo, para este primer entregable, han aportado eficazmente en las labores asignadas. Parte de ser estudiante y futuro profesional requiere de mejorar continuamente, lo cual se ha demostrado en esta entrega.<br>
            <strong>TP:</strong> Todos los miembros del equipo de trabajo han enfrentado dificultades de algún tipo durante el desarrollo del primer sprint, lo que deja una serie de aprendizajes que recalcan la importancia de adquirir conocimiento, tanto para el desarrollo en sí como para la planificación de este.<br>
            <strong>TB2:</strong> Todos los miembros del equipo de trabajo han trabajado en sus respectivas features, aportando eficazmente en la entrega de valor para el producto. Todos los integrantes reconocen el valor de la mejora continua en su aprendizaje.<br>
            <strong>TF:</strong> Todos los miembros del equipo de trabajado han completado sus features asignadas, aportando significativamente al desarrollo de las aplicaciones.<br>
            </td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><img src="./img/introduccion/team/carlos.png"></td>
            <td>
        ...
        <tr>
            <td><img src="./img/introduccion/team/alvaro.png"></td>
            <td>
        ...
        <tr>
            <td><img src="./img/introduccion/team/henry.png"></td>
...
- **Dueños**
<img src="./img/introduccion/lean_ux_process/protopersonas/dueno.jpg">

- **Tenderos**
<img src="./img/introduccion/lean_ux_process/protopersonas/tendero.jpg">
  ...
  <thead>
    ...
    <tr>
      ...
      <th scope="column" style="width:20%; text-align:center;">
        Soulware<br>
        <img src="./img/elicitation/startups/soulware.png" alt="Soulware logo" style="max-width:100px; display:block; margin:6px auto;">
      </th>
      <th scope="column" style="width:20%; text-align:center;">
        BSale<br>
        <img src="./img/elicitation/startups/bsale.png" alt="BSale logo" style="max-width:100px; display:block; margin:6px auto;">
      </th>
      <th scope="column" style="width:20%; text-align:center;">
        Relex<br>
        <img src="./img/elicitation/startups/relex.png" alt="Relex logo" style="max-width:100px; display:block; margin:6px auto;">
      </th>
      <th scope="column" style="width:20%; text-align:center;">
        Five Galaxies Commerce (Loyverse)<br>
        <img src="./img/elicitation/startups/loyverse.png" alt="Loyverse logo" style="max-width:100px; display:block; margin:6px auto;">
      </th>
    </tr>
  </thead>
  <tbody>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <strong>Nombre:</strong> Janet Pozo<br>
                <strong>Edad:</strong> 51 años<br>
            ...
            <td><img src="./img/elicitation/interviews/janet.png"></td>
        </tr>
        <tr>
            <td colspan="2">
                <strong>Resumen:</strong><br>
                Janet es una comerciante con 22 años de experiencia. Comparte detalles acerca de la forma en que gestiona su bodega. Para ella, lo más importante es la confianza y garantía que genera su negocio respecto a los productos, dado que de alguna manera, "trabaja con las familias".<br>
                Expresa además que algunos aspectos de administración del negocio se realizan "al ojo" o según proyecciones que realiza de forma intuitiva (como al comprar stock de fruta).<br>
...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <strong>Nombre:</strong> Giannina Tarazona<br>
                <strong>Edad:</strong> 40 años<br>
                <strong>Distrito:</strong> San Juan de Lurigancho<br>
                <strong>Enlace:</strong> <a href="">Entrevista en Stream</a><br>
                <strong>Inicio:</strong> 09:38 - 14:32<br>
            </td>
            <td><img src="./img/elicitation/interviews/giannina.png"></td>
        </tr>
        <tr>
            <td colspan="2">
                <strong>Resumen:</strong><br>
                Giannina comenta que ha trabajado en una bodega, relativamente grande, similar a un minimarket. Hace mucho énfasis en las reglas que establecía el dueño sobre como manejar el negocio, como el cuaderno de fiados, turnos de los tenderos y las responsabilidades a realizar al cierre de caja.<br>
                Comenta además que no es muy usual que se realicen pedidos por WhatsApp.
            </td>
        </tr>
        <tr>
            <td>
                <strong>Nombre:</strong> Adilcia Ramírez<br>
                <strong>Edad:</strong> 41 años<br>
                <strong>Distrito:</strong> San Juan de Miraflores<br>
                <strong>Enlace:</strong> <a href="">Entrevista en Stream</a><br>
                <strong>Inicio:</strong> 14:32 - 18:07<br>
            </td>
            <td><img src="./img/elicitation/interviews/adilcia.png"></td>
        </tr>
        <tr>
            <td colspan="2">
                <strong>Resumen:</strong><br>
                Adilcia ha trabajado como tendera hace aproximadamente 10 años, en el negocio de su cuñada. En su relato, comenta que seguía muy fielmente las indicaciones de la dueña del negocio en la atención: los precios de los productos, la política del fiado, etc.<br>
...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <strong>Nombre:</strong> Luis Maguiña<br>
                <strong>Edad:</strong> 20 años<br>
                <strong>Distrito:</strong> Surco<br>
                <strong>Enlace:</strong> <a href="">Entrevista en Stream</a><br>
                <strong>Inicio:</strong> 18:07 - 21:53<br>
            </td>
            <td><img src="./img/elicitation/interviews/luis.png"></td>
        </tr>
        <tr>
            <td colspan="2">
                <strong>Resumen:</strong><br>
                Luis es cliente habitual de una bodega cerca a la avenida El Derby. Comenta que tiene una serie de razones para acudir a la bodega, como la calidad de la atención o que ciertos productos los encuentra en mejor estado y calidad (por ejemplo, la fruta).<br>
                Comenta que sus compras suelen ser planificadas, pero ocasionalmente compra por gusto propio. Además que disfruta ir a la tienda pero no le gusta cuando se forma una larga cola debido al volumen de clientes.<br>
        ...
        <tr>
            <td>
                <strong>Nombre:</strong> Manuel Gutiérrez<br>
                <strong>Edad:</strong> 22 años<br>
                <strong>Distrito:</strong> La Molina<br>
                <strong>Enlace:</strong> <a href="">Entrevista en Stream</a><br>
                <strong>Inicio:</strong> 21:53 - 24:54<br>
            </td>
            <td><img src="./img/elicitation/interviews/manuel.png"></td>
        </tr>
        <tr>
            <td colspan="2">
                <strong>Resumen:</strong><br>
                Manuel es cliente habitual de una tienda. Describe que sus patrones de compra suelen ser más espontáneos, pero tiene cierta planificación de compras para los fines de semana.<br>
                Manuel cuenta que su bodega es su favorita principalmente por la proximidad de esta a su casa y la confianza con el dueño.<br>
...
<img src="./img/strategic-design/architecture/deploy.png" alt="C4: CONTAINER LEVEL">
...
<img src="./img/tactical-design/orders/component.png" alt="Orders Component in C3 Level">
...
<img src="./img/tactical-design/shopping/component.png" alt="Shopping Component in C3 Level">
...
<img src="./img/tactical-design/shopping/db.png" alt="Shopping db diagram">
...
<img src="./img/tactical-design/checkout/components.png" alt="Checkout Component in C3 Level">
...
- Landing page
[https://drive.google.com/file/d/1TrjPBKc_9GYHJ1vRV3ERk12cJlYhYQVd/view?usp=sharing](https://drive.google.com/file/d/1TrjPBKc_9GYHJ1vRV3ERk12cJlYhYQVd/view?usp=sharing)
- Prototipo en Figma
...
[https://drive.google.com/file/d/1m3KeVahoa1ikQAQEEZfgZDNLiCnq-uJV/view?usp=sharing](https://drive.google.com/file/d/1m3KeVahoa1ikQAQEEZfgZDNLiCnq-uJV/view?usp=sharing)
- API
...
- Application Kotlin
[https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210364_upc_edu_pe/IQDFHox7CkAlQ6oAfrKoJMGrAUbGEzrWwiY8nH7yljXryss?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=8fjRxc](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210364_upc_edu_pe/IQDFHox7CkAlQ6oAfrKoJMGrAUbGEzrWwiY8nH7yljXryss?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=8fjRxc)
- Aplicación Flutter
...
- Enlace de carpeta de exposición TF [Enlace (OneDrive)](https://upcedupe-my.sharepoint.com/:f:/g/personal/u202220783_upc_edu_pe/IgBMv3ZEtbpNRLSc41M3YgpjAZW5eumfqLnU_G-03epyT7M?e=xtoGy5)
